...
df = pd.read_csv("https://raw.githubusercontent.com/MartiSebastian/Prototyp/main/Daten_Ladestationen.csv")
...
df_positionen =  pd.read_csv("https://raw.githubusercontent.com/MartiSebastian/Prototyp/main/Positionen.csv")
